...
public class Context {
	...
	public Context(boolean single, String namePlayer1, String namePlayer2) {
		this.single = single;
	...
	public Context(boolean single, String difficulty, String nameChar1,
			String nameChar2, String namePlayer1, String namePlayer2,
			String environment) {
		this.single = single;
