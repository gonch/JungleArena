...
public class MapController {
     ...
     * creates a seemingly random number(noise) that can be repeated
     */
    ...
    /**
     * noise interpolation method used to generate a smoother output of the noise
     */
    ...
    public void generateMap(){
		...
		for(int i = 0; i < screenWidth; i ++){
			mapY[i] = screenHeight - perlinNoise_2D(i, r)*screenHeight - screenHeight/2;
		}
